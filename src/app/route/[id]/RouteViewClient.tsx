      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 -mt-8 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 relative z-10">
            <div className="group">
              <div className="flex items-center gap-2 mb-2">
                ...
                <div className="text-xs font-bold text-sb-navy-600 uppercase tracking-wide">Destinations</div>
              </div>
            ...
            <div className="group">
              <div className="flex items-center gap-2 mb-2">
                ...
                <div className="text-xs font-bold text-sb-navy-600 uppercase tracking-wide">Duration</div>
              </div>
            ...
            <div className="group">
              <div className="flex items-center gap-2 mb-2">
                ...
                <div className="text-xs font-bold text-sb-navy-600 uppercase tracking-wide">Travel Style</div>
              </div>
            ...
            <div className="group">
              <div className="flex items-center gap-2 mb-2">
                ...
                <div className="text-xs font-bold text-sb-navy-600 uppercase tracking-wide">Status</div>
              </div>
        ...
        {route.status === 'draft' && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="bg-gradient-to-r from-sb-orange-500 to-sb-teal-500 rounded-3xl p-8 text-white text-center mt-8"
          >
