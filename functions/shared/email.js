...
exports.generateRouteEmailHtml = generateRouteEmailHtml;
exports.generateRouteEmailText = generateRouteEmailText;
...
function generateRouteEmailHtml(routeId, routeUrl, name) {
...
function generateRouteEmailText(routeId, routeUrl, name) {
    const greeting = name ? `Hi ${name}!` : 'Hi there!';
    return `
Your Route is Saved!
